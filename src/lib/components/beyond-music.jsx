              ...
              <div className="w-48 h-48 rounded-2xl overflow-hidden bg-white/5 border border-white/10 shadow-xl relative group">
                <img
                  ...
                  className={`w-full h-full object-cover transition-all duration-700 ${
                    isPlaying ? "scale-110 brightness-110" : "scale-100"
                  }`}
                />
                {/* Overlay Glow */}
                {isPlaying && (
                ...
                return (
                  <div
                    ...
                    style={{
                      ...
                      top: isCenter ? "5%" : isInner ? "20%" : "30%",
                      transform: `translateX(-50%) translateY(0px) scale(${
                        isCenter ? 1 : isInner ? 0.8 : 0.65
                      })`,
                      filter: isCenter
                        ? "none"
                        : `blur(${isInner ? "1.5px" : "3px"})`,
                      opacity: isCenter ? 1 : isInner ? 0.85 : 0.7,
                      transition:
                      ...
                      <div
                        ...
                        style={{
                          ...
                          backdropFilter: isCenter
                            ? "blur(40px)"
                            : "blur(20px)",
                          padding: isCenter ? "24px" : "16px",
                          borderColor: isCenter
                            ? "rgba(255, 255, 255, 0.1)"
                            : "rgba(255, 255, 255, 0.05)",
                          willChange: "background-color, border-color, padding",
                        }}
                      >
                        {/* Reflection Overlay */}
                        ...
                        <div
                          ...
                          style={{
                            marginBottom: isCenter ? "16px" : "12px",
                          }}
                        >
                          <img
                            src={album.cover}
