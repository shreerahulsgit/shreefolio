...
const Footer = () => {
  ...
  return (
    <footer
      ref={ref}
      className="relative z-20 pt-12 pb-36 px-6"
    >
      <div className="max-w-3xl mx-auto">
        <div
          className={`flex flex-col items-center gap-6 transition-all duration-1000 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}
        >
          <span
          ...
          <div className="flex flex-col items-center gap-4 w-full max-w-md">
            <div
              className="flex items-center gap-4 px-6 py-3 rounded-2xl w-full justify-center cursor-pointer group transition-all duration-300 hover:scale-[1.02]"
              style={{
