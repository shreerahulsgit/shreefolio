...
const projects = [
  {
    ...
    description: "A sophisticated real-time analytics platform with machine learning insights and predictive modeling capabilities. Features include custom data visualization, anomaly detection, and automated reporting.",
  ...
  },
  {
    ...
    description: "Decentralized finance application with smart contract integration, wallet management, and token swapping features. Built with security-first architecture and optimized gas efficiency.",
    techStack: ["Next.js", "Web3.js", "Solidity", "Tailwind CSS", "Ethers.js"],
    images: [
  ...
  },
  {
    ...
    description: "Comprehensive tool for scheduling posts, analyzing engagement metrics, and managing multiple social platforms from one dashboard. Supports team collaboration and advanced analytics.",
  ...
  },
  {
    ...
    description: "Revolutionary shopping platform with augmented reality features allowing customers to visualize products in their space. Includes real-time 3D rendering and spatial mapping.",
    ...
    <div className="min-h-screen bg-[#0a0a0a] relative overflow-hidden">
      ...
      >
        ...
        <p className="text-gray-400 text-xl font-light max-w-2xl mx-auto leading-relaxed">
          A curated collection of innovative solutions crafted with precision and creativity
        </p>
      </motion.div>

      {/* Timeline Container with scroll-linked animation */}
      <div ref={timelineRef} className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-32">
            ...
            >
              ...
              `}>
                ...
                <motion.div
                  ...
                  initial={{ x: '-100%' }}
                  animate={{ x: hoveredCard === project.id ? '100%' : '-100%' }}
                ...
                <motion.div
                  ...
                  animate={{ x: hoveredCard === project.id ? 8 : 0 }}
                  transition={{ duration: 0.3 }}
                >
