        ...
        >
            ...
            <section className="relative pt-16 pb-10 px-4 sm:px-6 lg:px-8">
                <div className="max-w-7xl mx-auto text-center">
                    ...
                    >
                        <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold mb-6 bg-gradient-to-r from-white via-blue-100 to-purple-100 bg-clip-text text-transparent">
                            Certifications & Learning
                        </h1>
                        <p className="text-xl text-gray-400 max-w-3xl mx-auto">
                            A journey of continuous growth through<br/>
                            industry-recognized certifications and hands-on training
                        </p>
                    </motion.div>
                </div>
            </section>
                        ...
                        <div className="absolute inset-0 flex items-center justify-center">
                            <div className="relative w-full max-w-md h-96 preserve-3d">
                                {mainCertifications.map((cert, index) => {
                                    ...
                                    const prev =
                                        (activeCard - 1 + mainCertifications.length) %
                                        mainCertifications.length;
                                    const next =
                                        (activeCard + 1) %
                                        mainCertifications.length;
                ...
                <div className="max-w-5xl mx-auto">
                    ...
                    >
                        <div className="md:grid md:grid-cols-2 md:gap-8 items-center">
                            ...
                            <div className="md:text-right md:pr-12">
                                <h2
                                    className="text-4xl font-bold mb-5 bg-gradient-to-r from-blue-400 to-purple-400 
                    ...
                    >
                        <div className="md:grid md:grid-cols-2 md:gap-8 items-center">
                            ...
                            <div className="space-y-5 md:pr-12 order-2 md:order-1 flex flex-col md:items-end md:text-right">
                                {workshops.map((workshop, index) => {
                                    ...
                                    return (
                                        <motion.div
                                            ...
                                            transition={{ delay: index * 0.1 }}
                                            whileHover={{ scale: 1.02, x: -10 }}
                                            className="w-full bg-white/10 backdrop-blur-xl border border-white/20 rounded-xl p-6 
                                 hover:border-purple-500/50 hover:shadow-lg hover:shadow-purple-500/20 
                                 transition-all duration-300 group cursor-pointer"
                                        >
                                            <div className="flex items-center gap-4 md:flex-row-reverse md:justify-start">
                                                <div
