...
import { Download, Mountain, FileText, Zap, Flame, CheckCircle2 } from 'lucide-react';
...
const ClassifiedDocument = ({ onDownload, isVisible }) => {
  ...
  return (
    <div 
      className="relative max-w-4xl mx-auto pb-12 pt-4"
...
const ResumeMain = () => {
  ...
  const downloadResume = () => {
    const downloadUrl = '/shreerahul-resume.pdf';
    const link = document.createElement('a');
    link.href = downloadUrl;
    link.download = 'shreerahul-resume.pdf';
    link.target = '_blank';
      ...
      {accessState === 'unlocked' && (
        <div className="relative z-10 pt-16 pb-20 px-6">
          <div className="text-center mb-12">
            <h1 
              className={`text-3xl md:text-4xl lg:text-5xl font-bold mb-4 bg-clip-text text-transparent bg-gradient-to-r from-gray-200 via-white to-gray-200 transition-all duration-1000 ${isLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}
